...
test.describe('DataFactory Client API Integration', () => {
  ...
  test('should create client via real API endpoint', async ({ page }) => {
    ...
    const response = await page.request.get(`http://localhost:3000/api/v1/clients/${createdClient.id}`, {
  ...
  test('should retrieve existing test client', async ({ page }) => {
  ...
  test('should handle client creation with default values', async ({ page }) => {
  ...
  test('should handle business client creation', async ({ page }) => {
  ...
  test('should create client and use it for job creation', async ({ page }) => {
