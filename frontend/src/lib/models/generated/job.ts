...
jobConfig.attributes = [
    ...
    { name: 'status', type: 'string', nullable: false, enum: ["open", "in_progress", "paused", "waiting_for_customer", "waiting_for_scheduled_appointment", "successfully_completed", "cancelled"] },
    { name: 'priority', type: 'string', nullable: false, enum: ["critical", "high", "normal", "low", "proactive_followup"] }
];
