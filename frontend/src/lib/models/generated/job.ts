...
/**
 * TypeScript interface for Job model
...
/**
 * Factory instances for Job
 * Provides both ReactiveRecord (Svelte) and ActiveRecord (vanilla JS) implementations
 */
export const JobReactive = ModelFactory.createReactiveModel<Job>(jobConfig);
export const JobActive = ModelFactory.createActiveModel<Job>(jobConfig);

// Default export for convenience
export default JobReactive;
