 ...
 */
export type CreateContactMethodData = Omit<ContactMethodData, 'id' | 'created_at' | 'updated_at' | 'person'>;

/**
 * Update ContactMethod data interface
 * All fields optional except id, excludes relationships
 */
export type UpdateContactMethodData = Partial<Omit<ContactMethodData, 'id' | 'created_at' | 'updated_at' | 'person'>>;
