...
// Generated at: 2025-08-04T01:18:38Z
...
export type TableNames = 'activity_logs' | 'contact_methods' | 'jobs' | 'clients' | 'devices' | 'job_assignments' | 'job_people' | 'people_groups' | 'people_group_memberships' | 'notes' | 'job_targets' | 'scheduled_date_times' | 'scheduled_date_time_users' | 'people' | 'tasks' | 'users';
export type ModelNames = 'activity_log' | 'contact_method' | 'job' | 'client' | 'device' | 'job_assignment' | 'job_person' | 'people_group' | 'people_group_membership' | 'note' | 'job_target' | 'scheduled_date_time' | 'scheduled_date_time_user' | 'person' | 'task' | 'user';
