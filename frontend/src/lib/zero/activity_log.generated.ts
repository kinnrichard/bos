...
export const ActivityLog = {
  ...
  /**
   * Get all activity_logs (includes discarded records like Rails Task.all)
   * @returns Zero query result with array of activity_logs
   * 
   * @example
   * ```typescript
   * const allActivityLogs = ActivityLog.all();
   * console.log(allActivityLogs.current); // Array of activity_logs including discarded
   * ```
   */
  all() {
    const zero = getZero();
  ...
  /**
   * Find activity_logs matching conditions (includes discarded)
