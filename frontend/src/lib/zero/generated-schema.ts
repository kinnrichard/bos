...
// Generated at: 2025-08-04T13:18:04-04:00
//
...
// Users relationships
const usersRelationships = relationships(users, ({ _one, many }) => ({
  activityLogs: many({
    sourceField: ['id'],
...
const clientsRelationships = relationships(clients, ({ _one, many }) => ({
  activityLogs: many({
    sourceField: ['id'],
    destSchema: activity_logs,
...
// Notes relationships
const notesRelationships = relationships(notes, ({ one, _many }) => ({
  user: one({
    sourceField: ['user_id'],
    destField: ['id'],
    destSchema: users,
...
const activity_logsRelationships = relationships(activity_logs, ({ one, _many }) => ({
  user: one({
    sourceField: ['user_id'],
    destField: ['id'],
    destSchema: users,
...
const contact_methodsRelationships = relationships(contact_methods, ({ one, _many }) => ({
  person: one({
    sourceField: ['person_id'],
    destField: ['id'],
    destSchema: people,
...
const scheduled_date_timesRelationships = relationships(scheduled_date_times, ({ _one, many }) => ({
  activityLogs: many({
    sourceField: ['id'],
    destSchema: activity_logs,
    destField: ['loggable_id'],
...
const job_assignmentsRelationships = relationships(job_assignments, ({ one, _many }) => ({
  job: one({
    sourceField: ['job_id'],
    destField: ['id'],
    destSchema: jobs,
...
const job_peopleRelationships = relationships(job_people, ({ one, _many }) => ({
  job: one({
    sourceField: ['job_id'],
    destField: ['id'],
    destSchema: jobs,
