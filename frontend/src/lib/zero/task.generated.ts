...
// Generated at: 2025-07-14T05:39:59Z
//
 ...
 *   await instance.update({ title: 'Updated Title', position: 10 });
 ...
 */
async updateStatus(status: 'new_task' | 'in_progress' | 'paused' | 'successfully_completed' | 'cancelled'): Promise<{ id: string }> {
