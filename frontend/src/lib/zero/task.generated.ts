...
// Generated at: 2025-07-14T00:04:39Z
//
...
export class TaskInstance {
   ...
   */
  async update(data: Partial<UpdateTaskData>): Promise<{ id: string }> {
    return await updateTask(this.data.id, data);
  }

  /**
   * Soft delete this task (discard gem pattern)
   */
  async delete(): Promise<{ id: string }> {
    return await discardTask(this.data.id);
  }

  /**
   * Restore this task from soft delete
   */
